...
namespace WindowsFormsApp1
{
	public partial class AssignAdvisor : Form
	{
		...
		private void Save_Click(object sender, EventArgs e)
		{
			...
			{
				if (advisor.Text != "" && comboBox2.Text != "" &&comboBox1.Text != "")
				{

					con.Open();


					string a = "INSERT into ProjectAdvisor(AdvisorId, ProjectId, AdvisorRole, AssignmentDate) VALUES ((Select Id from Advisor where Advisor.Id =  '" + advisor.Text + "') , (Select Id FROM Project WHERE Title = '" + comboBox2.Text + "'), (SELECT Id FROM Lookup WHERE Category = 'ADVISOR_ROLE' AND Value = '" + comboBox1.Text + "'), '" + DateTime.Now + "')";
